...
private List<SiElementoBean> grpTipoZona;
    public MensajesData(){
    ...
    public List<ElementoMensajeroBean> getLstMensajero(String tipo){
        if(this.grpMensajeroList == null){
            this.grpMensajeroList = mensajeriaDao.getListMensajero(tipo);
    ...
    public List<SiElementoBean> getListTipoZona(String pctabCodtab){
        if(this.grpTipoZona == null){
            this.grpTipoZona = mensajeriaDao.getLsSiElementoBean(pctabCodtab);
        }
        return grpTipoZona;        
    } 
    /*-----Hermes 30/04/2019- Cambiar posición en campos de filtro módulo gestión de documentos-----*/
