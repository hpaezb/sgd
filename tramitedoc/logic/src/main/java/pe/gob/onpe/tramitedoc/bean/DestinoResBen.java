...
private String nroMensajeria;
private String coEmpDes;/*[HPB-02/10/20] Inicio - Plazo de Atencion-*/
private String esDocRec;/*[HPB-02/10/20] Inicio - Plazo de Atencion-*/
/*-- [HPB] Inicio 27/03/23 CLS-087-2022 --*/
private String feEnvCorObs;
/*-- [HPB] Fin 27/03/23 CLS-087-2022 --*/
    public String getNroMensajeria() {
        return nroMensajeria;
    }

    public void setNroMensajeria(String nroMensajeria) {
        this.nroMensajeria = nroMensajeria;
    }
    ...
    public String getDeIndica() {
        return deIndica;
    }

    public void setDeIndica(String deIndica) {
        this.deIndica = deIndica;
    }
    ...
    /*-- [HPB] Inicio 27/03/23 CLS-087-2022 --*/
    public String getFeEnvCorObs() {
        return feEnvCorObs;
    }

    public void setFeEnvCorObs(String feEnvCorObs) {
        this.feEnvCorObs = feEnvCorObs;
    }
    /*-- [HPB] Fin 27/03/23 CLS-087-2022 --*/
}
