    ...
    public String changeToEmitido(DocumentoEmiBean documentoEmiBean, String prutaDoc, Usuario usuario) throws Exception{
        ...
        if(pesDocEmi!=null && !pesDocEmi.equals("")){
            try{
                ...
                /*----Requerimiento 3 Hermes 16/04/2019----*/
                TblRemitosBean tblRemitosBean = emiDocumentoPersonalDao.getDatosDocumentoPersonal(documentoEmiBean.getNuAnn(), documentoEmiBean.getNuEmi());
