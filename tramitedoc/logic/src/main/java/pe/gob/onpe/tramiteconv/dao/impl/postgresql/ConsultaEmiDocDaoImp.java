...
//        sql.append(" B.NU_DOC,UPPER(A.DE_ASU) DE_ASU_M,A.NU_ANN,B.NU_EXPEDIENTE,A.NU_EMI,A.TI_CAP,B.IN_EXISTE_DOC EXISTE_DOC,DECODE(COALESCE(B.TI_EMI_REF,'0')||COALESCE(B.IN_EXISTE_ANEXO,'2'),'00',0,'02',0,1) EXISTE_ANEXO, COALESCE(B.CO_PRIORIDAD,'1') CO_PRIORIDAD,");
