...
public interface DocumentoXmlService {
    ...
    //jazanero
    DatosPlantillaDoc datosParaPlantillaGlosa(String pnuAnn, String pnuEmi);
    DocumentoObjBean crearDocxProyecto(String pnuAnn, String pnuEmi);
    DatosPlantillaDoc datosParaPlantillaProyecto(String pnuAnn, String pnuEmi);
