...
*/
    ...
    public StringBuilder readHttpAndWriteInOutput(InputStream in) throws Exception{
        ...
        try{
                ...
                if(m_con!=null){
                    ...
                    if(contentType!=null && contentType.equals("application/pdf")){
                       ...
                       StringBuilder sf =  readHttpAndWriteInOutput(m_con.getInputStream());
  ...
  /**
   ...
   private void eliminarArchivoFisicamente(String nombre_archivo) {
		File tem= new File(applicationProperties.getRutaTemporal(),nombre_archivo);       		
		if(tem.exists()&& tem.isFile()){
                    if(tem.delete())
                    {
                        System.out.println("archivo: "+nombre_archivo +"Elimando con exito");
                    }else{
                        System.out.println("archivo: "+nombre_archivo +"no pudo ser eliminado");
                    }
		}
    }
