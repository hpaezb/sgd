...
public class ConsultaDocVoBoDaoImp extends SimpleJdbcDaoBase implements ConsultaDocVoBoDao{
	...
	sql.append(" CONVERT(datetime,EX.FE_EXP,103)FE_EXP_CORTA,");    
        ...
        sql.append(" FROM IDOSGD.TDTV_REMITOS RE LEFT JOIN IDOSGD.TDTC_EXPEDIENTE EX");
        sql.append(" ON RE.NU_ANN_EXP=EX.NU_ANN_EXP AND RE.NU_SEC_EXP=EX.NU_SEC_EXP,IDOSGD.TDTV_PERSONAL_VB VB");
