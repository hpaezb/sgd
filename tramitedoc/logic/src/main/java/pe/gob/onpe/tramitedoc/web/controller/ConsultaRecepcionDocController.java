...
//        consultaRecepDocService.estadoRecepcionDocumento(buscarDocumentoRecepConsulBean,"");
    ...
    public String goInicio(BuscarDocumentoRecepConsulBean buscarDocumentoRecepConsulBean, HttpServletRequest request,  BindingResult result, Model model){
        ...
        try{
            ...
            /* GCT 30/07/2020 - Inicio - Requerimiento Paginación consulta recepcion */
            listCantidad = consultaRecepDocService.getDocumentosBuscaRecepAdmFiltroSize(buscarDocumentoRecepConsulBean);
            System.out.println("SIZEx: "+listCantidad.size());
            ...
            list = consultaRecepDocService.getDocumentosBuscaRecepAdmFiltro(buscarDocumentoRecepConsulBean, vPagina, cantidad);
...
//           model.addAttribute("pdesEmp",usuario.getDeFullName());
    ...
    public String goBuscaDocumentoEnReferencia(BuscarDocumentoRecepConsulBean buscarDocumentoRecepConsulBean, HttpServletRequest request,  BindingResult result, Model model){
        ...
        vPagina = ServletUtility.getInstancia().loadRequestParameter(request, "vPagina");
        /* GCT 30/07/2020 - Fin - Requerimiento Paginación consulta recepcion */        
       //System.out.println("BuscaDocumentoEnReferencia");
        try{
            //mp = consultaRecepDocService.getDocumentosEnReferencia(buscarDocumentoRecepConsulBean);
            /* GCT 30/07/2020 - Inicio - Requerimiento Paginación consulta recepcion */
            mp = consultaRecepDocService.getDocumentosEnReferenciaSize(buscarDocumentoRecepConsulBean);
            String cantPorPagina = commonQryService.obtenerValorParametro("CANT_POR_PAGINA");
            ...
            if(paginasx > 0)
                paginas = paginas + 1;  
            mp = consultaRecepDocService.getDocumentosEnReferencia(buscarDocumentoRecepConsulBean, vPagina, cantidad);      
