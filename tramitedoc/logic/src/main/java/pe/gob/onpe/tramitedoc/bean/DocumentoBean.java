...
public class DocumentoBean extends ReporteBean {
    ...
    /**
     * @return the feexptext
     */
    public String getFeexptext() {
        return feexptext;
    }

    /**
     * @param feexptext the feexptext to set
     */
    public void setFeexptext(String feexptext) {
        this.feexptext = feexptext;
    }

    public String getCoAvanceRec() {
        return coAvanceRec;
    }
    ...
    public String getNuAnnDocOriPlazoAtencion() {
        return nuAnnDocOriPlazoAtencion;
    }

    public void setNuAnnDocOriPlazoAtencion(String nuAnnDocOriPlazoAtencion) {
        this.nuAnnDocOriPlazoAtencion = nuAnnDocOriPlazoAtencion;
    }

    public String getNuEmiDocOriPlazoAtencion() {
        return nuEmiDocOriPlazoAtencion;
    }
