 ...
 */
@Repository("cargoEntregaInternoDao")
public class CargoEntregaInternoDaoImp extends SimpleJdbcDaoBase implements CargoEntregaInternoDao{
    ...
    public List<CargoEntregaBean> getCargosEntregaInterno(CargoEntregaBean cargo) {
        ...
        System.out.println("SQL CARGO INTERNO--> "+sql);
        try {
    ...
    public List<DocPedienteEntregaBean> getDocsPendienteEntregaInterno(DocPedienteEntregaBean busqDoc) {
        ...
        sql.append(" AND A.TI_EMI NOT IN ('05')");
...
//            }
        ...
        if (pTipoBusqueda.equals("1"))
        {
            ...
            if (busqDoc.getNuExpediente()!= null && busqDoc.getNuExpediente().trim().length()>0){
               //sql.append(" AND UPPER(C.NU_EXPEDIENTE) LIKE '%'||:pnuExpediente||'%' ");
               sql.append(" AND UPPER(C.NU_EXPEDIENTE) IN("+busqDoc.getNuExpediente()+") ");
               objectParam.put("pnuExpediente", busqDoc.getNuExpediente());
            }
            // Busqueda del Asunto
        ...
        sql.append(") A ");
        sql.append("WHERE ROWNUM < 51");
        System.out.println("SQL CARGO PENDIENTE INTERNO--> "+sql);
        try {
    ...
    @Override
    public String isDocPendienteEnGuiaMpInterno(String pnuAnn, String pnuEmi, String pnuDes) {
    ...
    @Override
    public DocPedienteEntregaBean getDocPendienteEntregaInterno(String pnuAnn, String pnuEmi, String pnuDes) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public String insGuiaMpInterno(GuiaMesaPartesBean guia) {
    ...
    @Override
    public String insDetGuiaMpInterno(DetGuiaMesaPartesBean detGuia) {
        String vReturn = "NO_OK";
        StringBuilder sqlUpd = new StringBuilder();
    ...
    @Override
    public String getNroGuiaCabeceraInterno(String pnuAnnGuia) {
        String vReturn="-1";
        try {
    ...
    @Override
    public String getNroCorrelativoGuiaCabeceraInterno(String pnuAnnGuia, String pcoDepOri) {
        String vReturn="-1";
        try {
    ...
    @Override
    public String getNroCorrelativoDetGuiaCabeceraInterno(String pnuAnnGuia, String pnuGuia) {
        String vReturn="-1";
        try {
    ...
    @Override
    public String updGuiaMpInterno(GuiaMesaPartesBean guia) {
        String vReturn = "NO_OK";
        StringBuilder sqlUpd = new StringBuilder();
    ...
    @Override
    public String updEstadoGuiaMpInterno(String estado, String pcoUseMod, String pnuAnnGuia, String pnuGuia) {
        String vReturn = "NO_OK";
        StringBuilder sqlUpd = new StringBuilder();
    ...
    @Override
    public DocPedienteEntregaBean getDependenciaDestinoDocExtRecInterno(String pnuAnn, String pnuEmi, String pnuDes) {
        StringBuilder sql = new StringBuilder();
    ...
    @Override
    public List<CargoEntregaBean> getListaReporteBusquedaInterno(CargoEntregaBean cargo) {
        String vResult;
