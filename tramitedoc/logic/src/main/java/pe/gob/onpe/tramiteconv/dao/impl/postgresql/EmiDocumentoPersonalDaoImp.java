...
//	sql.append(" B.IN_EXISTE_DOC EXISTE_DOC,DECODE(NVL(B.TI_EMI_REF,'0')||NVL(B.IN_EXISTE_ANEXO,'2'),'00',0,'02',0,1) EXISTE_ANEXO");
    ...
    public DocumentoEmiBean getDocumentoEmiAdmNew(String codDependencia,String codEmpleado,String codLocal){
       StringBuilder sql = new StringBuilder();
        sql.append("select IDOSGD.PK_SGD_DESCRIPCION_FU_INICIALES_EMP(?)||'-'||IDOSGD.PK_SGD_DESCRIPCION_DE_SIGLA(?) de_doc_sig,\n" +
        ...
        try {
            documentoEmiBean = this.jdbcTemplate.queryForObject(sql.toString(), BeanPropertyRowMapper.newInstance(DocumentoEmiBean.class),
                    new Object[]{codEmpleado,codDependencia,codDependencia,codDependencia,codLocal,codLocal,codEmpleado,codEmpleado});
        } catch (EmptyResultDataAccessException e) {
            documentoEmiBean = null;
        } catch (Exception e) {
            e.printStackTrace();
...
//                + "NU_DES=?");
    ...
    public String insDocumentoEmiBean(DocumentoEmiBean documentoEmiBean){
        ...
        StringBuilder  sqlQry3 = new StringBuilder();
        ...
        try {
            ...
            this.jdbcTemplate.update(sqlUpd.toString(), new Object[]{documentoEmiBean.getNuAnn(),snuEmi,snuCorEmi,
                ...
                documentoEmiBean.getDeAsu(),Integer.parseInt(documentoEmiBean.getNuDiaAte()),documentoEmiBean.getCoTipDocAdm(),Integer.parseInt(documentoEmiBean.getCoEmpEmi()),
                documentoEmiBean.getDeDocSig(),documentoEmiBean.getCoUseMod(),documentoEmiBean.getCoUseMod(),snuDoc,snuDocEmi});
...
//            documentoEmiBean.getCoDepEmi(),documentoEmiBean.getCoTipDocAdm(),documentoEmiBean.getNuDocEmi()});
    ...
    @Override
    public TblRemitosBean getDatosDocumentoPersonal(String pnuAnn, String pnuEmi) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
