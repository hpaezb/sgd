...
public interface DatosPlantillaDao {
    ...
    List<PlantillaDocx> getLstPlantillasDocx(String pcoDep);
    List<PlantillaDocx> getLstPlantillasDocxGlosa(String pcoDep);
//    PlantillaDocx getPlantillaDocx(String pcoDep);
    
    //jazanero
    DatosPlantillaDoc getDocumentoEmitidoProyecto(String pnuAnn, String pnuEmi);
    List<DestinatarioDocumentoEmiBean> getLstDestintariosProyecto(String pnuAnn, String pnuEmi);
