...
//        sql.append(" DECODE (X.NU_CANDES,1, TD_PK_TRAMITE.TI_DES_EMP (X.NU_ANN, X.NU_EMI),TD_PK_TRAMITE.TI_DES_EMP_V (X.NU_ANN, X.NU_EMI)) DE_EMP_DES,");
        sql.append("CASE\n"
...
//                + "a.co_dep_des co_dependencia,NVL2(a.co_dep_des,substr(IDOSGD.PK_SGD_DESCRIPCION_DE_DEPENDENCIA(a.co_dep_des), 1, 100),NULL) de_dependencia,\n"
...
//                + "a.co_emp_des co_empleado,NVL2(a.co_emp_des,substr(IDOSGD.PK_SGD_DESCRIPCION_DE_NOM_EMP(a.co_emp_des), 1, 100),NULL) de_empleado,\n"
...
//                + "a.co_mot co_tramite,NVL2(a.co_mot,substr(IDOSGD.PK_SGD_DESCRIPCION_MOTIVO(a.co_mot), 1, 100),NULL) de_tramite,\n"
                + "a.co_mot co_tramite,"
...
//                + "a.NU_RUC_DES nu_ruc,NVL2(a.NU_RUC_DES,substr(TD_PK_DESCRIPCION.DE_PROVEEDOR(a.NU_RUC_DES), 1, 100),NULL) de_proveedor,\n"
                + "a.NU_RUC_DES nu_ruc,"
//                + "NVL2(a.NU_RUC_DES,substr(TD_PK_DESCRIPCION.DE_PROVEEDOR(a.NU_RUC_DES), 1, 100),NULL) de_proveedor,\n"
...
//                + "a.NU_DNI_DES nu_dni,NVL2(a.NU_DNI_DES,substr(TD_PK_DESCRIPCION.ANI_SIMIL(a.NU_DNI_DES), 1, 100),NULL) de_ciudadano,\n"
                + "a.NU_DNI_DES nu_dni,"
//                + "NVL2(a.NU_DNI_DES,substr(TD_PK_DESCRIPCION.ANI_SIMIL(a.NU_DNI_DES), 1, 100),NULL) de_ciudadano,\n"
