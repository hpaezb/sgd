...
public class NotificacionDaoImp extends SimpleJdbcDaoBase implements NotificacionDao{
    ...
    public DocumentoDatoBean getDatosDoc(String nuAnn, String nuEmi){
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT A.NU_EMI, A.NU_ANN,TO_CHAR(A.FE_EMI,'DD/MM/YYYY HH24:MI') FECHA_DOC, B.NU_DOC SIGLAS_DOC, A.DE_ASU, A.ES_DOC_EMI, IDOSGD.PK_SGD_DESCRIPCION_DE_DOCUMENTO(A.CO_TIP_DOC_ADM) TIPO_DOC,\n" +
