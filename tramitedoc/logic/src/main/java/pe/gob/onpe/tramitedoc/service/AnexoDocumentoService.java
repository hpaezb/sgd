...
public interface AnexoDocumentoService {
    ...
    String getDocAutorizado(String pcoUser,String pnuAnn, String pnuEmi, String pcoDep);

    List<ReferenciaBean> getDocumentosSeguimiento(String pnuAnn,String pnuEmi,String pnuDes,String pcoUser,String pcoDep);
    String getSeguimientoJson(String pnuAnn, String pnuEmi,String pnuDes,int nivel,String pcoUser,String pcoDep);
    String getSeguimientoRoot(String pnuAnn, String pnuEmi,String pnuDes,int nivel,String pcoUser,String pcoDep);
    ...
    //jazanero
    String getVerificaDocxDoc(String pnuAnn, String pnuEmi, String pnuAne);
}
