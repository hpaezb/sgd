...
public class SeguiEstRecibidoDaoImp extends SimpleJdbcDaoQuery implements SeguiEstRecibidoDao {
    ...
    private static Logger logger=Logger.getLogger(SeguiEstRecibidoDaoImp.class);
    ...
    public List<DocumentoSeguiEstRecibidoBean> getListDocSeguiEstRec(BuscarDocumentoSeguiEstRecBean buscarDocumentoSeguiEstRecBean) {
        ...
        sql.append(" PK_SGD_DESCRIPCION.ESTADOS (X.ES_DOC_REC,'TDTV_DESTINOS') DE_ES_DOC_DES,X.ES_DOC_REC ES_DOC_REC, ");
    ...
    public DocumentoRecepSeguiBean getDocumentoRecepAdmSegui(String snuAnn, String snuEmi, String snuDes) {
        ...
        try {
            ...
            logger.error("nu_ann=" + snuAnn + "," + "nu_emi=" + snuEmi + "nu_des=" + snuDes);
            e.printStackTrace();
        }
...
//        sql.append("WHERE ROWNUM < 301");
    ...
    public List<DocumentoSeguiEstRecibidoBean> getListaReporteBusqueda(BuscarDocumentoSeguiEstRecBean buscarDocumentoSeguiEstRecBean) {
        ...
        sql.append("SELECT B.NU_COR_DES,\n" +
                ...
                "                REPLACE(PK_SGD_DESCRIPCION.TI_EMI_EMP(A.NU_ANN, A.NU_EMI),'PROVEEDOR - ','') DE_ORI_EMI,\n" +
