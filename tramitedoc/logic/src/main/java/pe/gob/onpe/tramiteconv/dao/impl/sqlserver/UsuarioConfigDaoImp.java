...
public class UsuarioConfigDaoImp extends SimpleJdbcDaoBase implements UsuarioConfigDao {
    ...
    public String updUsuarioConfing(UsuarioConfigBean usuarioConf) {
        ...
        sql.append("de_dir_emi=?, de_pie_pagina=?, ti_acceso=?, in_carga_doc=?, in_firma=?, in_tipo_doc =?, fe_use_mod=CURRENT_TIMESTAMP ");
    ...
    @Override
    public List<UsuarioDependenciaAcceso> getListDependenciaAccesos(String string, String string1) {
