...
public class ProveedorDaoImp extends SimpleJdbcDaoBase implements ProveedorDao {
    ...
    public String insProveedor(ProveedorBean proveedor) {
        ...
        sql.append("(cpro_ruc, dpro_fecins ,cpro_razsoc, cpro_domicil, cubi_coddep, cubi_codpro, cubi_coddis , cpro_telefo) ");
        ...
        try {
            ...
            this.jdbcTemplate.update(sql.toString(), new Object[]{
                ...
                proveedor.getCubiCoddep(), proveedor.getCubiCodpro(), proveedor.getCubiCoddis(),proveedor.getCproTelefo()
            });
            vReturn = "OK";
    ...
    public String updProveedor(ProveedorBean proveedor, String codProveedor) {
        ...
        sql.append("cpro_ruc=?, cpro_razsoc=?, cpro_domicil=?, cubi_coddep=?, cubi_codpro = ?, cubi_coddis= ? , cpro_telefo =? ");
        sql.append("where cpro_ruc=? ");
        
        try {
            this.jdbcTemplate.update(sql.toString(), new Object[]{
                proveedor.getNuRuc(), proveedor.getDescripcion(), proveedor.getCproDomicil(), proveedor.getCubiCoddep(), 
                proveedor.getCubiCodpro(), proveedor.getCubiCoddis(), proveedor.getCproTelefo(), proveedor.getNuRuc()
            });
            vReturn = "OK";
        } catch (Exception e) {
            e.printStackTrace();
