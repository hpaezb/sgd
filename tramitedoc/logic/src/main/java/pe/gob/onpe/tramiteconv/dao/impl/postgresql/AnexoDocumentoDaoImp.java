...
//                    "                 '05', nvl(a.nu_doc_emi,' ') || '-' || a.nu_ann || '-' || a.de_doc_sig,nvl(a.de_doc_sig,'S/N')) li_nu_doc,\n" +
                    ...
                    + "substr("
//                + "DECODE (a.ti_emi,\n" +
//                    "      '01', IDOSGD.PK_SGD_DESCRIPCION_de_dependencia (a.co_dep_emi),\n" +
//                    "      '02', IDOSGD.PK_SGD_DESCRIPCION_de_proveedor (a.nu_ruc_emi),\n" +
//                    "      '03', 'CIUDADANO - ' ||IDOSGD.PK_SGD_DESCRIPCION_ani_simil (a.nu_dni_emi),\n" +
//                    "      '04', IDOSGD.PK_SGD_DESCRIPCION_otro_origen (a.co_otr_ori_emi),\n" +
//                    "      '05', IDOSGD.PK_SGD_DESCRIPCION_de_nom_emp (a.co_emp_emi)\n" +
//                    "     )"
                ...
                + ",1,100) de_dep_emi, \n" +
                    ...
                    "b.nu_ann_ref,\n" +
                    "b.nu_emi_ref,\n" +
                    "COALESCE(CAST(b.nu_des_ref AS TEXT),'N') nu_des_ref\n" +
...
//                    "      '01', IDOSGD.PK_SGD_DESCRIPCION_de_dependencia (a.co_dep_emi),\n" +
//                    "      '02', IDOSGD.PK_SGD_DESCRIPCION_de_proveedor (a.nu_ruc_emi),\n" +
//                    "      '03', 'CIUDADANO - ' ||IDOSGD.td_pk_descripcion.ani_simil (a.nu_dni_emi),\n" +
//                    "      '04', IDOSGD.PK_SGD_DESCRIPCION_otro_origen (a.co_otr_ori_emi),\n" +
//                    "      '05', IDOSGD.PK_SGD_DESCRIPCION_de_nom_emp (a.co_emp_emi)\n" +
//                    "     )"
                + "CASE WHEN a.ti_emi='01' THEN     IDOSGD.PK_SGD_DESCRIPCION_de_dependencia (a.co_dep_emi) \n" +
...
//                + "                '04', IDOSGD.PK_SGD_DESCRIPCION_otro_origen(c.co_otr_ori_des),' ')"
                ...
                + "a.nu_ann_ref,\n"
                + "a.nu_emi_ref \n"
                + "FROM IDOSGD.tdtr_referencia a, IDOSGD.tdtv_remitos b , IDOSGD.tdtv_destinos c \n"
    ...
    public List<ReferenciaBean> getDocumentoEmiSeg(String pnuAnn, String pnuEmi, String pnuDes) {
        ...
        sql.append("SELECT \n"
                + "IDOSGD.PK_SGD_DESCRIPCION_de_documento (b.co_tip_doc_adm) li_tip_doc, \n"
//                + "DECODE (b.ti_emi,'01', b.nu_doc_emi || '-' || b.nu_ann || '-' || b.de_doc_sig, \n"
//                + "                 '05', b.nu_doc_emi || '-' || b.nu_ann || '-' || b.de_doc_sig,COALESCE(b.de_doc_sig,'S/N')) li_nu_doc, \n"
                + "CASE WHEN b.ti_emi='01' THEN COALESCE(b.nu_doc_emi,' ') || '-' || b.nu_ann || '-' || COALESCE(b.de_doc_sig,' ') \n"
                + "WHEN b.ti_emi='05' THEN COALESCE(b.nu_doc_emi,' ') || '-' || b.nu_ann || '-' || COALESCE(b.de_doc_sig,' ') \n"
                + "ELSE COALESCE(b.de_doc_sig,'S/N') END AS li_nu_doc, \n"
                
                + "substr(IDOSGD.PK_SGD_DESCRIPCION_DE_DEPENDENCIA(b.co_dep_emi), 1, 100) de_dep_emi, \n"
//                + "DECODE(c.ti_des,'01', td_pk_descripcion.de_dependencia(c.co_dep_des),\n"
//                + "                '02', td_pk_descripcion.de_proveedor(c.nu_ruc_des),\n"
//                + "                '03', 'CIUDADANO - ' || td_pk_descripcion.ani_simil(c.nu_dni_des),\n"
//                + "                '04', IDOSGD.PK_SGD_DESCRIPCION_otro_origen(c.co_otr_ori_des),' ') de_dep_des,\n"
                + "CASE WHEN c.ti_des='01' THEN IDOSGD.PK_SGD_DESCRIPCION_de_dependencia(c.co_dep_des) \n"
                + "WHEN c.ti_des='02' THEN IDOSGD.PK_SGD_DESCRIPCION_de_proveedor(c.nu_ruc_des) \n"
                + "WHEN c.ti_des='03' THEN 'CIUDADANO - ' || IDOSGD.PK_SGD_DESCRIPCION_ani_simil(c.nu_dni_des) \n"
                ...
                + "c.nu_emi, \n"
                + "CAST(c.nu_des AS TEXT) nu_des \n"
                + "FROM IDOSGD.tdtv_remitos b , IDOSGD.tdtv_destinos c \n"
...
//                + "and nu_ane>?");
    ...
    public String insArchivoAnexo(final DocumentoAnexoBean docAnexo, final InputStream archivoAnexo, final int size) {
        ...
        sql.append("insert into idosgd.tdtv_anexos(\n"
                ...
                + "feula, \n"
                + "bl_doc )\n"
                + "values(?,?,cast(? as smallint),REGEXP_REPLACE(?, '[^-_ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz0-9ÁÉÍÓÚáéíóú. ]', ''),REGEXP_REPLACE(?, '[^-_ABCDEFGHIJKLMNÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz0-9ÁÉÍÓÚáéíóú. ]', ' '),?,now(),?,now(),to_char(now(),'yyyymmdd'),?)");
