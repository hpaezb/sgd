...
public class ConsultaDocVoBoDaoImp extends SimpleJdbcDaoQuery implements ConsultaDocVoBoDao{
    ...
    private static Logger logger=Logger.getLogger(ConsultaDocVoBoDaoImp.class);
    ...
    public List<DocumentoVoBoBean> getLsDocsVoBo(BuscarDocumentoVoBoBean bDocVoBo) {
        ...
        sql.append("	(SELECT DE_EST FROM TDTR_ESTADOS WHERE CO_EST || DE_TAB = DECODE(VB.IN_VB,'B','0',VB.IN_VB) || 'TDTV_PERSONAL_VB') DE_ES_DOC_EMI, VB.IN_VB ES_DOC_EMI, ");
    ...
    public DocumentoVoBoBean getDocumentoVoBo(String pnuAnn, String pnuEmi, String coDep, String coEmpVb) {
        ...
        sql.append("SELECT \n" +
                    ...
                    "VB.IN_VB ES_DOC_EMI, RE.NU_DIA_ATE, \n" +
                    "RE.DE_ASU, \n" +
        ...
        try {
            ...
            logger.info("nu_ann="+pnuAnn+","+"nu_emi="+pnuEmi);
            e.printStackTrace();
        }
        return docVobo;
    }
