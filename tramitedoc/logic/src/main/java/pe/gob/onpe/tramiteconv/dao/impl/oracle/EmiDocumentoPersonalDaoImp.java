...
public class EmiDocumentoPersonalDaoImp   extends SimpleJdbcDaoBase implements EmiDocumentoPersonalDao{
        ...
        private static Logger logger=Logger.getLogger(EmiDocumentoPersonalDaoImp.class);
        @Override
    ...
    public String insDocumentoEmiBean(DocumentoEmiBean documentoEmiBean){
        ...
        try {
            ...
            this.jdbcTemplate.update(sqlUpd.toString(), new Object[]{documentoEmiBean.getNuAnn(),snuEmi,snuCorEmi,
                ...
                documentoEmiBean.getDeDocSig(),documentoEmiBean.getNuAnnExp(), documentoEmiBean.getNuSecExp(),documentoEmiBean.getNuDetExp(), documentoEmiBean.getNuEmiProyecto(), documentoEmiBean.getNuAnnProyecto(), documentoEmiBean.getCoUseMod(),documentoEmiBean.getCoUseMod(),snuDoc,snuDocEmi});
                /* [HPB] Fin 24/02/23 CLS-087-2022 */
