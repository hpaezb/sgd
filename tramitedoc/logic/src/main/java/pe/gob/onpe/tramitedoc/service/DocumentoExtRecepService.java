...
public interface DocumentoExtRecepService {
    ...
    /*Enlace Expedientes - Hermes 17/09/2018*/
    String getValidaExpEquals(DocumentoExtRecepBean documentoExtRecepBean) throws Exception;/*-- [HPB] VALIDA DATOS DEL DOCUMENTO EN EXPEDIENTE 14/07/20--*/
    String changeToParaSubsanar(DocumentoExtRecepBean documentoExtRecepBean, Usuario usuario) throws Exception;/*[HPB-22/07/21] Inicio - Adicionar estado POR SUBSANAR */
    String changeToArchivar(DocumentoExtRecepBean documentoExtRecepBean, Usuario usuario) throws Exception;/*[HPB-22/07/21] Inicio - Adicionar estado POR SUBSANAR */
    String updObservacionExpedienteBean(String nuAnnExp, String nuSecExp, String deObservacion, String coUsuario) throws Exception;/*[HPB-22/07/21] Adicionar estado POR SUBSANAR */
    ...
    public ReporteBean getGenerarReporteHojaRuta(BuscarDocumentoExtRecepBean buscarDocumentoExtRecepBean, Map parametros, String nuAnn, String nuEmi, String tipo);
