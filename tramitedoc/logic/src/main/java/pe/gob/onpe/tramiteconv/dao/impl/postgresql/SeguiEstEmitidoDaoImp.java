...
//        sql.append("'01', IDOSGD.PK_SGD_DESCRIPCION_DE_DEPENDENCIA (X.CO_DEP_DES)|| ' - ' ||IDOSGD.PK_SGD_DESCRIPCION_DE_NOM_EMP (X.CO_EMP_DES),");
...
//        sql.append(" C.IN_EXISTE_DOC EXISTE_DOC,DECODE(COALESCE(C.TI_EMI_REF,'0')|| COALESCE(C.IN_EXISTE_ANEXO,'2'),'00',0,'02',0,1) EXISTE_ANEXO, COALESCE(B.CO_PRI,'1') CO_PRI,B.ES_DOC_REC,");
