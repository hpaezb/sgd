...
public class ConsultaEmisionDocController {
    ...
    public String goInicio(BuscarDocumentoEmiConsulBean buscarDocumentoEmiConsulBean, HttpServletRequest request,  BindingResult result, Model model){
        ...
        try{
            ...
            //list = consultaEmiDocService.getDocumentosBuscaEmiAdmFiltro(buscarDocumentoEmiConsulBean);//Hermes 05/09/2018
            /* HPB 28/05/2020 - Inicio - Requerimiento Paginación consulta emitidos */
            listCantidad = consultaEmiDocService.getDocumentosBuscaEmiAdmFiltroSize(buscarDocumentoEmiConsulBean);
            ...
            list = consultaEmiDocService.getDocumentosBuscaEmiAdmFiltro(buscarDocumentoEmiConsulBean, vPagina, cantidad);
    ...
    public String goBuscaDestinatario(HttpServletRequest request, Model model){
        ...
        model.addAttribute("listaDestinatario",referencedData.getListDestinatarioEmiFiltro(pnuAnn,usuarioConfigBean));//Hermes 05/09/2018
...
//        model.addAttribute("annioActual", Utility.getInstancia().dateToFormatStringYYYY(new Date()));
        ...
        try{
            ...
            /* HPB 28/05/2020 - Inicio - Requerimiento Paginación consulta emitidos */
            mp = consultaEmiDocService.getDocumentosEnReferenciaSize(buscarDocumentoEmiConsulBean);
            String cantPorPagina = commonQryService.obtenerValorParametro("CANT_POR_PAGINA");
            ...
            if(paginasx > 0)
                paginas = paginas + 1;  
            mp = consultaEmiDocService.getDocumentosEnReferencia(buscarDocumentoEmiConsulBean, vPagina, cantidad);        
