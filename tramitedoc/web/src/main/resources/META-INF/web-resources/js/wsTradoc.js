    ...
    ajaxCall("/config.do?accion=goDatosPC", datosPC,function(data) {
         //console.log("datos==>"+data);
            if(!!data && data.retval){
                ...
                $("#appletIco a").attr("class", "").css({color: '#5CB85C'});/*[HPB] 30/10/20 Refrescar check verde*/
                appOnpeResponse="OK";
...
//function fn_refreshCheckWebSocket(coDep){
//        var waitToResponseApp = function() {
//        if (ispageLoad) {
//            console.log("estado new"+ispageLoad);
//            if(!isCallAppDesktop&&nroPestana===0){
//                console.log('tradoc new 1');
