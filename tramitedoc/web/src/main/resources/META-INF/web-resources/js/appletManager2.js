...
function runApplet(applet, param, callback) {
    ...
    if (auxEjecucion === tipoEjecucionApplet.ejeAppletModoNormal) {
        ...
        switch (applet)
        {
            case 1:
                ...
                break;
            case 2:
                console.log("param.urlDoc->"+param.urlDoc);
                console.log("param.rutaDoc->"+param.rutaDoc);
            ...
            case 5:
                ...
                break;
            case 6:
                rpta = fn_verificaSiExisteDocApplet(param.rutaDoc, param.remplazaArchivo);
                callback(rpta);
                return;
                break;
            case 7:
    ...
    //alert("Entra a applet auxiliar ->"+auxEjecucion);
    if (auxEjecucion === tipoEjecucionApplet.ejeAppletModoAuxilar) {
        var confApplet = "";
