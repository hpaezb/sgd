...
function fu_validaFormConfBusRecepDocExtConsul(noForm) {
    ...
    console.log("antes a");
    /*------------Hermes 13/07/2018---Se comento la validación------*/
//    if(!(!!vnuEmi||!!vnuDoc||!!vdeExp||!!vdeAsu)){
//       alert_Warning("Buscar: ","Ingresar Algún Dato del Expediente.");
//       valRetorno = "0";
//    }
    /*---------------------------------------------------------------*/
    console.log("antes b");
...
function fu_iniTblDocsExternos(){
    ...
    $(nomTabla+" tbody tr").click(function() {
        ...
        if ($(this).hasClass('row_selected')) {
            ...
            var pcoEstadoDoc = $(this).children('td')[15].innerHTML;
            jQuery('#txtCoEstadoDoc').val(pcoEstadoDoc);//Hermes - 28/05/2019            
            if(!!pnuAnn&&!!pnuEmi){
...
function submitAjaxFormRecepDocExtSegui(tipo,noForm) {
    ...
    console.log("validaFiltro->"+validaFiltro);
    if (validaFiltro === "1") {
...
function fu_iniTblSeguiDocsExternos(objJson){
    //SEGUIMIENTO DE ESTADOS DE DOCUMENTOS EXTERNOS RECEPCIONADOS
    if(!!objJson){
        var noForm='#buscarDocExtRecSeguiEstado';
    ...
    $(nomTabla+" tbody tr").click(function() {
        ...
        if ($(this).hasClass('row_selected')) {
            ...
            var pcoEstadoDoc = $(this).children('td')[21].innerHTML;
            jQuery('#txtCoEstadoDoc').val(pcoEstadoDoc);//Hermes - 28/05/2019             
