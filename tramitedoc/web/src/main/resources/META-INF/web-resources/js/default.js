...
/*HPB 18/09/2019 Avance de recepcionados*/
var icoAvance={
    0:"glyphicon glyphicon-tag",
    1:"glyphicon glyphicon-list"
};
/*HPB 18/09/2019 Avance de recepcionados*/
...
var coloresVencimientoPlazoAtencion = {
    0: {"text": "Normal", "color": "#009BE6", "descrip": "Documentos sin plazo de atención.", "cssClass": "estadoVenNormal"},
    1: {"text": "Pendiente", "color": "#E97200", "descrip": "Tiempo de vecimiento mayor a 2 días.", "cssClass": "estadoPorVencerPlazoAtencion"},    
    2: {"text": "Próximo a vencer", "color": "#F6A953", "descrip": "Con vencimiento menor o igual a 2 días.", "cssClass": "estadoProximoVencerPlazoAtencion"},
    3: {"text": "Vence hoy", "color": "#000000", "descrip": "Plazo de atención igual a la fecha actual.", "cssClass": "estadoVenceHoyPlazoAtencion"},
    4: {"text": "Atendido", "color": "#5CB85C", "descrip": "Documentos con la fecha de atención o archivamiento.", "cssClass": "estadoAtendidoPlazoAtencion"},
    5: {"text": "Vencido", "color": "#222222", "descrip": "Plazo de atención posterior a la fecha actual.", "cssClass": "estadoVencidoPlazoAtencion"}
};

//var coloresVencimientoPlazoAtencion = {
//    0: {"color": "#009BE6", "descrip": "Documentos sin plazo de atención.", "cssClass": "estadoVenNormal"},
//    1: {"color": "#E97200", "descrip": "Tiempo de vecimiento mayor a 2 días.", "cssClass": "estadoPorVencerPlazoAtencion"},    
//    2: {"color": "#F6A953", "descrip": "Con vencimiento menor o igual a 2 días.", "cssClass": "estadoProximoVencerPlazoAtencion"},
//    3: {"color": "#D00000", "descrip": "Plazo de atención igual a la fecha actual.", "cssClass": "estadoVenceHoyPlazoAtencion"},
//    4: {"color": "#5CB85C", "descrip": "Documentos con la fecha de atención o archivamiento.", "cssClass": "estadoAtendidoPlazoAtencion"},
//    5: {"color": "#222222", "descrip": "Plazo de atención posterior a la fecha actual.", "cssClass": "estadoVencidoPlazoAtencion"}
//};
var icoAlertaPlazoAtencion={
    1:"glyphicon glyphicon-bell"
};
/*[HPB-02/10/20] Inicio - Plazo de Atencion*/
...
function inicioMenuStd() {
    ...
    console.log("Entre inicioMenuStd");
    jQuery('#divBandejaEntrada').show();
    console.log("Exit inicioMenuStd");
}
...
function cerrarPantalla() {
    console.log("cerrarPantalla");
    refrescarBandejaEntrada();
    //dojo.byId("applicationPanel").innerHTML=" ";
    jQuery("#applicationPanel").html(" ");
    inicioMenuStd();
    console.log("exit cerrarPantalla");
}

function cerrarPantallaMP() {
    //dojo.byId("applicationPanel").innerHTML=" ";
    console.log("cerrarPantallaMP");
    jQuery("#applicationPanel").html(" ");
    inicioMenuStd();
    console.log("exit cerrarPantallaMP");
}

function cerrarPantallaConfigTabla() {
    //dojo.byId("applicationPanel").innerHTML=" ";
    console.log("cerrarPantallaConfigTabla");
    jQuery("#applicationPanel").html(" ");
    inicioMenuStd();
    console.log("exit ");
}
...
function refrescarBandejaEntrada() {
    console.log("refrescarBandejaEntrada");
    var p = new Array();
    p[0] = "accion=goInicio";
    ...
    console.log("/srBandejaEntrada.do");
...
function fn_updDependenciaUsuario() {
    var pcoUsuario1 = jQuery('#coUsuario').val();/*Hermes 07/10/19 LDAP*/
    var pcoUsuario = pcoUsuario1.toUpperCase();/*Hermes 07/10/19 LDAP*/
    jQuery('#coDep').val("");
...
function fn_mostrar_manual(){
    ...
    var path = '../Manuales/Manual_SGD_new.pdf';
...
/*HPB 18/09/2019 Avance de recepcionados*/
function getIcoAvance(id) {
    try {
        var id = parseInt(id);
        if (id < Object.keys(icoAvance).length && id >= 0) {
            return icoAvance[id];
        } else {
            return "";
        }
...
function setEtiquetasListaDoc(idTable,col) {
    ...
    $("#"+idTable+" tbody tr").each(function() {
        ...
        var a = aux.split("_");
        var id = a[0];
        var idAvance = a[1];/*HPB 18/09/2019 Avance de recepcionados*/
        var label = a[2];
        var clase = getIcoEtiqueta(id);
        var claseAvance = getIcoAvance(idAvance);/*HPB 18/09/2019 Avance de recepcionados*/
        var ico = "<span title='Etiqueta' class='" + clase + "'></span> ";
        /*HPB 18/09/2019 Avance de recepcionados*/
        var icoAvance = "<span title='Avance' class='" + claseAvance + "'></span> ";
        if (parseInt(id) === 0 && parseInt(idAvance) !== 0) {
            $(this).find("td:eq("+col+")").html(icoAvance + label);
        }else if (parseInt(id) !== 0 && parseInt(idAvance) === 0) {
            $(this).find("td:eq("+col+")").html(ico + label);
        }else if (parseInt(id) === 0 && parseInt(idAvance) === 0) {
            $(this).find("td:eq("+col+")").html(label);
        }else if (parseInt(id) !== 0 && parseInt(idAvance) !== 0) {
            $(this).find("td:eq("+col+")").html(ico + icoAvance + label);
        }
        /*HPB 18/09/2019 Avance de recepcionados*/
    });
}
...
/*[HPB] 30/10/20 Refrescar check verde*/
function fn_refreshCheckWebSocket(pcoDep) {
    console.log('oficina: '+pcoDep);
    try{cerrarConexion_wsocket();}catch(ex){}
    var noForm ="#depFormNew";
    jQuery(noForm).find('#txtCoDep').val(pcoDep);
    jQuery(noForm).submit();
}
/*[HPB] 30/10/20 Refrescar check verde*/